...
{
    public class UpdateIdentityPatientValidatorTests
    {
        private readonly Mock<IUnitOfWork> _mockUnitOfWork;
        private readonly Mock<IIdentityService> _mockIdentityService;
        private readonly UpdateIdentityPatientValidator _validator;
        public UpdateIdentityPatientValidatorTests()
        {
            ...
            _validator = new UpdateIdentityPatientValidator(_mockIdentityService.Object, _mockUnitOfWork.Object);
        }
        ...
        {
            SetupMocks(1, "user123", "old@test.com", "oldUser1");
            var command = new UpdateIdentityPatientCommand { Id = 1, Email = "exists@test.com", UserName = "any" };
