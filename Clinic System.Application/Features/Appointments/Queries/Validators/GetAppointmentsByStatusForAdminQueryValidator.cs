...
{
    public class GetAppointmentsByStatusForAdminQueryValidator : AbstractValidator<GetAppointmentsByStatusForAdminQuery>
    {
        public GetAppointmentsByStatusForAdminQueryValidator()
        {
